---
sidebar_position: 6
sidebar_label: "Client (React + three.js)"
---
...
MIT - see [LICENSE](https://github.com/realitycollective/com.realitycollective.service-framework.ts/blob/development/LICENSE).
