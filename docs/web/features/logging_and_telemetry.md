---
sidebar_position: 1
sidebar_label: "Logging and telemetry"
---
...
A working version, with a bounded ring, sink isolation and NDJSON export, is in [`runtime-examples/telemetry-example`](https://github.com/realitycollective/com.realitycollective.service-framework.ts/blob/development/runtime-examples/telemetry-example).
...
- [`runtime-examples/telemetry-example`](https://github.com/realitycollective/com.realitycollective.service-framework.ts/blob/development/runtime-examples/telemetry-example) - a runnable failure you can only diagnose with telemetry on
- [Service design](../basics/03_service_design.md) - service authoring and consumption
